...
11. *i = 1: 1² = 1*, valid partition `[1]`. Add 1.
12. *i = 9: 9² = 81*, valid partition `[8, 1]`. Add 81.
13. *i = 10: 10² = 100*, valid partition `[10, 0]`. Add 100.
14. *i = 36: 36² = 1296*, valid partition `[1, 29, 6]`. Add 1296.
